...
<template>
    ...
    <el-table-column label="出栏时间" prop="out_time">
			</el-table-column>
...
export default {
  ...
  methods: {
    ...
    tableListSearch() {
      ...
      getSellPigList_api(getData).then(res => {
    ...
    toLookInfo(index) {
      ...
      getSellPigInfo_api(data).then(res => {
        console.log("res", res.data);
    ...
    toDelete(index) {
      ...
      deleteSellPigList_api(data).then(res => {
        console.log("toDelete", res);
        this.getBuyPigList();
      });
    },
    getBuyPigList() {
