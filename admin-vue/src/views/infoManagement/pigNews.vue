...
<template>
    ...
    <el-dialog :visible.sync="dialogVisible_info">
        ...
        <el-form label-position="right" label-width="80px" :model="form">
				...
				<el-form-item label="视频">
					<video :src="form.video" controls="controls" style="width:300px;height:200px;">your browser does not support the video tag</video>
				</el-form-item>
				<el-form-item label="分类">
                   {{form.class_name}}
                </el-form-item>
...
export default {
  ...
  methods: {
    ...
    toSelectClass() {
      ...
      this.getSomeList({ class_id: this.selectValue });
    },
    toDelete(index) {
      //删除
      let data = {
